// test_boost_asio_tcp_client_blocking_timeout.cpp : Defines the entry point for the console application.
//
...
public:
		...
		boost::posix_time::time_duration timeout)
	{
		...
		boost::asio::async_connect(socket_, iter, boost::bind(&client::handle_connect, this, _1, &ec));
	...
	std::string read(boost::posix_time::time_duration timeout)
	{
		...
		// operation completes. The blocking_udp_client.cpp example shows how you
		// can use boost::bind rather than boost::lambda.
		boost::asio::async_read(socket_, input_buffer_, boost::asio::transfer_at_least(1), boost::bind(&client::handle_read, this, _1, _2, &ec, &length));
...
int main(int argc, char* argv[])
{
	try
	{
		...
		client c;
		c.connect("localhost", "10001", boost::posix_time::seconds(10));
